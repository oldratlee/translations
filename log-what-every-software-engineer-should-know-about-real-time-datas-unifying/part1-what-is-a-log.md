...
1. [变更日志101：表与事件的二相性（`duality`）](#变更日志101表与事件的二相性duality)
1. [接下来的内容](#接下来的内容)
...
**_【译注】_** 分布式系统的 时间、次序、时钟是个最基础根本的问题，详见被引用最多的**_Leslie Lamport_**的论文**_Time Clocks and the Ordering of Events in a Distributed System_**（[中文翻译](http://duanple.blog.163.com/blog/static/709717672012920101343237/)），现在先 **_不要_** 去看，除非读完本文后你还是有很兴趣要探个明白！
